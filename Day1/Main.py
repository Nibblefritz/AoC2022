with open ('C:/Users/Kyleq/OneDrive/src/AOC2022/Day1/test.txt') as day_1_data:
...
print(f'The highest total that an elf is carrying is: {max(all_elf_totals)} calories.')
